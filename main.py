...
audio_extraction_path='/content/drive/MyDrive/any2English/temp/audio.wav'
...
def extract_audio(video_path, output_path):
    command = f'ffmpeg -i {video_path} -vn -ab 128k -ar 44100 -y {output_path}'
...
if __name__ == '__main__':
  ...
  print('Model loading for whisper')
  model = whisper.load_model("medium")

  video_file = args.face
  output_file = audio_extraction_path
  extract_audio(video_file,output_file)
  

  result = model.transcribe(audio_extraction_path,task="translate", beam_size=5, best_of=5)
